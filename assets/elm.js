...
var $author$project$Pages$NotFound$details = {description: 'The page you are looking for does not exist.', path: '404', title: 'Page Not Found'};
var $author$project$Main$urlToPage = function (url) {
	var _v0 = url.path;
	return $author$project$Page$NotFound($author$project$Pages$NotFound$details);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Strandersson.se')
					])),
				A2(
				$elm$html$Html$ul,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$Main$viewLink, 'Contact', '/contact')
							]))
					]))
			]));
};
...
var $author$project$Main$view = function (model) {
	var page = $author$project$Main$urlToPage(model.url);
	return {
		body: _List_fromArray(
			[
				$author$project$Main$viewHeader(model),
				$author$project$Main$viewPage(page)
			]),
		title: 'Strandersson.se ' + $author$project$Main$pageToString(page)
	};
};
